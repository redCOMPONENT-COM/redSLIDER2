...
$messDetectorWarnings = shell_exec(REPO_BASE . '/vendor/bin/phpmd ' . REPO_BASE . '/modules/ text codesize,unusedcode,controversial');
fwrite(STDOUT, $messDetectorWarnings);

$messDetectorWarnings = shell_exec(REPO_BASE . '/vendor/bin/phpmd ' . REPO_BASE . '/plugins/ text codesize,unusedcode,controversial');
fwrite(STDOUT, $messDetectorWarnings);

$messDetectorWarnings = shell_exec(REPO_BASE . '/vendor/bin/phpmd ' . REPO_BASE . '/libraries/ text codesize,unusedcode,controversial');
fwrite(STDOUT, $messDetectorWarnings);
