...
$ignored = array(
	...
	REPO_BASE . '/libraries/mpdf/*',
	REPO_BASE . '/libraries/redslider/table/*',
	REPO_BASE . '/libraries/redslider/helper/*',
	REPO_BASE . '/libraries/redslider/form/*',
	REPO_BASE . '/libraries/redslider/vendor/*',
	REPO_BASE . '/modules/site/*/tmpl/*',
	REPO_BASE . '/modules/site/*/language/*',
	REPO_BASE . '/modules/site/*/css/*',
	REPO_BASE . '/media/*/css/*',
	REPO_BASE . '/media/*/js/*',
	REPO_BASE . '/media/*/images/*',
	REPO_BASE . '/plugins/*/*/css/*',
	REPO_BASE . '/plugins/*/*/js/*',
