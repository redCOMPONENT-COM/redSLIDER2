 ...
 * 2.4.8 of the compiled jar file is bundled with this task, however a different
...
class YuiCompressorTask extends Task
{
    ...
    public function __construct()
    {
        $defaultJarPath = realpath(
            dirname(__FILE__) . '/includes/yuicompressor-2.4.8.jar'
        );
        $this->_javaPath = 'java';
    ...
    public function main()
    {
        ...
        foreach ($this->_fileSets as $fileSet) {
            ...
            foreach ($files as $file) {
                ...
                $target = new PhingFile($this->_targetDir, pathinfo($file, PATHINFO_FILENAME) . '.min.' . pathinfo($file, PATHINFO_EXTENSION));
