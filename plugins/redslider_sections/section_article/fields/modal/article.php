...
class JFormFieldModal_Article extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '<a class="btn modalArticleAjax" title="**Select**" href="' . $link . '&amp;' . JSession::getFormToken() . '=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">' . JText::_('PLG_REDSLIDER_SECTION_ARTICLE_SELECT_ARTICLE_BUTTON') . '</a>';
		$html[] = '</div>';
